...
export default function FlashcardsWorkspace() {
  ...
  return (
    <div id="flashcards-workspace" className="absolute inset-0 w-full h-full bg-white overflow-hidden">
      
      {/* Absolute full-bleed iframe for FlashDeck */}
      <iframe
        key={iframeKey}
        src="/flashdeck.html"
        className="w-full h-full border-none bg-white"
        title="FlashDeck Workspace"
